...
setting the drivers take, and the three parts of the physics that decide what a
run actually computes — how far into the ionizing band the grid reaches,
which stochastic-heating solver resolves `P(T)`, and what the polarized optics
cover.

...
\item \textbf{No circular polarization.} The released optics table carries
      $Q_{\rm ext}$, $Q_{\rm abs}$ and $Q_{\rm sca}$ but no phase retardation,
      so $C_{\rm circ}$ cannot be formed and must be set to zero.

...
model was built from, and two tables ship: the default
...
prepends nothing, so every earlier result is bit-identical. What it does
for astrodust depends on the table: on the 1129-wavelength one a floor
below \SI{0.0912}{\micro\meter} builds a band, while the \texttt{\_euv}
table already

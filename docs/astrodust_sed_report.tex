...
\texttt{dust\_extinction}: absent, they change nothing. For astrodust
there is now nothing left to ask for either: the table already reaches
...
frozen at the table boundary. The two astrodust products now cover the
same grid and read every wavelength of it, the ionizing band included,
off the $Q$ table: \texttt{euv} has nothing left to prepend, and the
files differ only in the columns they carry, the field width they are
written with, and their headers.

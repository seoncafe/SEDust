...
In the extended band the astrodust optics come from Bohren--Huffman Mie
on the DH21 dielectric function --- the same material as the table, so
the model does not change composition at the seam. The carbonaceous
...
$b/a = 1.4$ oblate spheroid; the extended band uses Mie for the
volume-equivalent \emph{sphere}. The justification is \emph{not} the
...
In the size-integrated curve the step across

...
against the HD23 release. The \code{tmatrix/} directory now links both
\code{tmd\_one.f}, the random-orientation average driver, and
\code{ampl\_oriented.f}, Mishchenko's fixed-orientation amplitude routine,
...
$Z(\lambda,\theta)$, aligned orientation &
  ...
  \code{ampl\_oriented.f} and size-integrated over the aligned population,
...
orientation-dependent amplitude matrix is evaluated by \code{AMPL}, in the build
as \code{ampl\_oriented.f}. Retaining it at all scattering angles and assembling

...
sections directly. Circular polarization remains unavailable: neither the release
table nor the regenerated one stores a phase lag, only $Q_{\rm ext}$, $Q_{\rm abs}$
and $Q_{\rm sca}$, so \Ccirc\ cannot be built from either.
